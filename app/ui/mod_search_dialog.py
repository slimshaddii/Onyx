...
class ModSearchDialog(QDialog):
    ...
    def _build(self):
        ...
        # Debounce search input — 300ms after typing stops
    ...
    def _run_search(self):
        ...
        # Also check instance mod lists for mids not in all_mods
        ...
        for mid, info in sorted(matches.items(),
            ...
            # Count how many instances use this mod
            active_in   = [i for i in self.instances if mid in i.mods]
            inactive_in = [i for i in self.instances
                           if mid in i.inactive_mods]
            ...
            # Child rows — one per instance that has it
            ...
            # Don't show unused instances — too noisy with many instances
            # Only show if mod is in no instances at all
